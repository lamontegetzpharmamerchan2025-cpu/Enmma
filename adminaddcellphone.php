...
<body> 
    ...
    <section class="container addproducts ml-auto text-black">
      ...
      <h6 class="m-0">(SMARTPHONES)</h6>
      <br>
      <form method="POST" enctype="multipart/form-data" action="cellphone_add.php">
        <div class="form-row">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="hidden" class="form-control" name="itemtype" id="itemtype" value="Cellphone">
        ...
        <button type="submit" class="btn btn-success" name="addcellphone">ADD ITEM</button>
      ...
      <section class="container addproductstables ml-auto text-black">
        <table class="table">
            ...
            <tbody>         
            <?php
                    $tsql = sqlsrv_query($conn,"SELECT * from itemtaborig WHERE itemtype='Cellphone' and itemstatus='NOTPOST'");
